...
pin_trait_impl!(crate::spi::CsPin, SPI1, PB21, 1);
pin_trait_impl!(crate::spi::SckPin, SPI1, PB15, 1);
pin_trait_impl!(crate::spi::MisoPin, SPI1, PA8, 1);
pin_trait_impl!(crate::spi::MosiPin, SPI1, PA9, 1);

pin_trait_impl!(crate::spi::CsPin, SPI1, PA12, 2);
pin_trait_impl!(crate::spi::SckPin, SPI1, PA11, 2);
pin_trait_impl!(crate::spi::MisoPin, SPI1, PA9, 2);
pin_trait_impl!(crate::spi::MosiPin, SPI1, PA10, 2);

pin_trait_impl!(crate::spi::CsPin, SPI1, PC4, 3);
pin_trait_impl!(crate::spi::SckPin, SPI1, PC5, 3);
pin_trait_impl!(crate::spi::MisoPin, SPI1, PC6, 3);
pin_trait_impl!(crate::spi::MosiPin, SPI1, PC7, 3);
